...
string[] windowsSdksInstalls = new string[]
{
    "https://go.microsoft.com/fwlink/p/?linkid=2120843", //19041
    "https://go.microsoft.com/fwlink/?linkid=2083338", //18362
    "https://go.microsoft.com/fwlink/p/?linkid=864422", //16299
    "https://go.microsoft.com/fwlink/p/?LinkId=838916" //14393
};
...
Task("provision-windowssdk")
    ...
    .Does(() =>
    {
        ...
        {
            int i = 0;
            foreach(var installUrl in windowsSdksInstalls)
            {
